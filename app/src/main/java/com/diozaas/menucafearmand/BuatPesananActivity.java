        ...
        pesan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (nama.getText().toString().isEmpty()) {
                    ...
                    Toast.makeText(BuatPesananActivity.this, "Silakan masukan Nama terlebih dahulu!", Toast.LENGTH_SHORT).show();
                } else if (nomor_meja.getText().toString().isEmpty()) {
                    nomor_meja.setError("Silakan masukan Nomor meja anda!");
                    Toast.makeText(BuatPesananActivity.this, "Silakan masukan Nomo meja anda terlebih dahulu!", Toast.LENGTH_SHORT).show();
                } else {
                    if (batagor.isChecked() || cireng.isChecked() || nasi_goreng.isChecked() || kopi.isChecked() || capucino.isChecked() || tea.isChecked() || keju.isChecked() || salad.isChecked()) {
                        ...
                        if (Integer.parseInt(t1.getText().toString()) > 0 || Integer.parseInt(t2.getText().toString()) > 0 || Integer.parseInt(t3.getText().toString()) > 0 || Integer.parseInt(t4.getText().toString()) > 0 || Integer.parseInt(t5.getText().toString()) > 0 || Integer.parseInt(t6.getText().toString()) > 0 || Integer.parseInt(t7.getText().toString()) > 0 || Integer.parseInt(t8.getText().toString()) > 0) {
                            if (getIntent().getStringExtra("status").equalsIgnoreCase("update")) {
                                ...
                                Toast.makeText(BuatPesananActivity.this, "Pesanan sudah update dan di masukan ke daftar pesanan. TerimaKasih !", Toast.LENGTH_SHORT).show();
                                Intent i;
                                i = new Intent(BuatPesananActivity.this,ListPesanan.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                startActivity(i);
                                ...
                                if (cursor.getCount() < 1) {
                                    ...
                                    Toast.makeText(BuatPesananActivity.this, "Pesanan sudah tersimpan, silahkan menunggu ! Terimakasih !", Toast.LENGTH_SHORT).show();
                                    Intent i;
                                    i = new Intent(BuatPesananActivity.this, ListPesanan.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                    startActivity(i);
                                } else {
                                    Toast.makeText(BuatPesananActivity.this, "Meja sudah di booking, silahkan pilih yang lain. Terimakasih !", Toast.LENGTH_SHORT).show();
                                }
                            }
                        } else {
                            Toast.makeText(BuatPesananActivity.this, "Masukan jumlah pesanan terlebih dahulu !", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(BuatPesananActivity.this, "Harap pesan terlebih dahulu !", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
